...
import { LoginContext } from '../../helpers/Context'
import './SecondLogin.scss'
import MoveComments from './movecomment';
import axios from 'axios'
...
const SecondLogin = () => {
  ...
  //       const userComments = commentsResponse.data.User;
      ...
      axios
        ...
        .then((res) => {
          if (res.data.message === "No users found") {
            ...
            // Log approved comments to the console
            console.log('User Approved Comments:', res.data.users);
          }
        })
        .catch((err) => {
          console.log(err);
  ...
  //   const updatedComments = Array.from(approvedComments);
  //   const [reorderedComment] = updatedComments.splice(result.source.index, 1);
  //   updatedComments.splice(result.destination.index, 0, reorderedComment);
        ...
        <div className="containersl">
          ...
          <div className="container2sl">
            {/* <div className="comments">
              ...
              <div id="commentsscroll">{approvedComments && (approvedComments.length!==0) &&
              <>
                {approvedComments.map((val) =>
                        <div id="comment">
                          <p id="commentp">{val.comment}</p>
        ...
        {/* ------------------------------------------------------------------------ */}
          ...
          <div className="container2sl">
            <div className="comments2">
              ...
              <div id="commentsscroll">{comments && (comments.length!==0) &&
              <>
                {comments.map((val) =>
                        <div id="comment">
                          <p id="commentp">{val.comment}</p>
            ...
            <div className="comments3">
              ...
              <ul style={{ display: 'block' }}>{myComments && (myComments.length!==0) &&
              <>
                {myComments.map((val, index) =>
                          <li id="comment5">
                            <p className="newComment">{val.comment}</p>
