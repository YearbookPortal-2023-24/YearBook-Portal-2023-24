...
const About = () => {
  return (
    <div className='bg-white flex flex-col  items-center justify-center text-base md:text-3xl'>
      <div className='flex flex-col md:flex-row items-center mt-2 md:mt-10 text-base md:text-3xl'>
      ...
      <div className='flex flex-col  md:flex-row items-center mb-[20px]  md:mt-10 text-base md:text-3xl'>
      ...
      <div className='flex flex-col md:flex-row items-center mt-[20px] md:mt-10 text-base md:text-3xl'>
