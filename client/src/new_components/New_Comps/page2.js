   ...
   {/* some classes are defined in fill details3 .css such as bgr */}
    ...
    <div className=" h-[100vh] w-[100vw] text-black bg-bg-white bg-cover ">
      ...
      <div class="h-60 relative top-[30px] flex flex-col items-center lg:top-[70px]  afl ">
           ...
           <div class="text-[18px] ml-2 top-10 relative font-bold sm:text-2xl md:text-3xl tracking-wide lg:mr-[100px]">Hmm, looks like you are<span class="text-red-700 text-2xl md:text-3xl lg:text-4xl"> NOT </span>graduating this year</div>

           <p class="text-[18px] top-16 relative font-bold md:text-3xl sm:text-2xl lg:mt-4 tracking-wide lg:mr-[200px] mb-8">Thanks for signing up, anyway!</p>
          
           <p class="text-[18px] mb-16 top-12 relative font-bold md:text-3xl sm:text-2xl lg:w-auto lg:top-8 lg:mt-5">Here's a gold card for all your troubles</p>
