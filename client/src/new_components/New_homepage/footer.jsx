...
const Footer = () => {
  return (
    ...
    <div className='snap-start bg-bg-white bg-cover flex flex-col md:flex-row px-6 md:px-12 py-8'>
  <div className='w-full md:w-1/2 flex flex-col gap-6 md:gap-12 items-center md:items-start'>
    ...
    <div className='flex flex-col md:flex-row gap-6 md:gap-12 justify-center'>
      ...
      <img src="/images/homepage/down_arrow.png" className='mt-6 md:-mt-12 w-16 md:w-32 h-16 md:h-32 rotate-90'></img>
    </div>

    <div className='text-center md:text-left'>
      <h1 className='text-lg md:text-2xl'>Made with ❤️, by <span className='text-3xl md:text-5xl'> Alumni Cell</span></h1>
      <h1 className='text-lg md:text-2xl'>The Alumni Cell is the student-run cell to connect and broaden the institute's alum network.</h1>
    </div>
  ...
  <div className='w-full md:w-1/2 flex flex-col gap-6 md:gap-12 items-center md:items-start'>
    <h1 className='text-3xl md:text-5xl text-center md:text-left'>The Alumni Portal? That's here</h1>
    <div className='flex flex-col md:flex-row-reverse gap-6 md:gap-12 justify-center'>
      ...
      <img src="/images/homepage/down_arrow.png" className='mt-6 md:-mt-12 w-16 md:w-32 h-16 md:h-32 rotate-90 scale-y-[-1]'></img>
    </div>

    <h1 className='text-3xl md:text-5xl ml-0 md:ml-32'>Find us On</h1>
    <div className='flex flex-row gap-6 md:gap-12 w-full px-6 md:px-24'>
    ...
    <h1 className='text-3xl md:text-5xl ml-0 md:ml-32'>More Links</h1>
    <div className='flex flex-col md:flex-row gap-6 md:gap-12 w-full px-6 md:px-24'>
