...
<> 
      <div class=" h-fit w-screen bg-slate-100  " >
         ...
         <div class={hid == 5 ? " h-screen w-screen text-black flex justify-center items-center text-1xl relative border-green-600 border-b-2 bgr fadeInRight " : "hidden"}>
...
<button onClick={() => {
         ...
         <div class={hid == 3 ? " h-screen w-screen text-black flex justify-center items-center text-1xl relative border-green-600 border-b-2  bgr" : "hidden"}>
            ...
            <button onClick={() => {}} class="border-2 border-black h-9 w-32 bottom-12 left-[120px] top-[485px] md:bottom-36 absolute md:right-[322px]  p-0 text-base leading-none text-center  rounded-3xl md:top-96 md:mt-32   md:w-32 md:h-10  lg:mt-2 lg:left-80 xl:left-[580px] xl:top-[400px] btnh border-dashed afu"> Upload Photo </button>
...
<button onClick={() => {
         ...
         <div class={hid == 4 ? " h-[218vh]  md:h-[105vh]  w-screen text-black flex flex-row md:justify-center md:items-center text-1xl relative border-green-600 border-b-2 bgr " : "hidden"}>
           ...
           <div class="h-12 w-full text-3xl top-[122px] left-[42px] md:left-4 absolute  md:text-4xl md:top-28 lg:text-[42px] xl:text-4xl xl:top-44 flex    lg:left-[23rem] tmp asr"> Maybe, also fill these as well ?  </div>
            ...
            }} class="border-2 border-black h-8 w-32 bottom-[2rem] btnForBig left-32 flex items-center justify-center absolute lg:left-[469px] lg:bottom-[4rem]  p-0 text-base leading-none text-center  rounded-3xl md:bottom-[7rem] md:mt-32   md:w-32 md:h-10  lg:mt-8 xl:bottom-10  xl:left-[648px] btnh border-dashed afd "
            > Continue </button>
